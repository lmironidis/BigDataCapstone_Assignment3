...
# 
# Description:
#   his R script will find the Min, Max, and Average Mean values of
#   Sulfate and Nitrate concentrations with the locations answering
#   numbers 2-5. The function header takes the directory with specdata 
#   of all 332 csv files and gives the option whether to loop through 
#   specific sets of csv's in order to find the Min, Max, and Average
#   Mean values of Sulfate and Nitrate concentrations.
